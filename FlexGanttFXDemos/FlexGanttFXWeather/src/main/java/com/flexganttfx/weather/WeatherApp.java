 ...
 */
package com.flexganttfx.weather;
...
/**
 * Standalone entry point for the FlexGanttFX World Climate Explorer demo.
 *
 * <p>Displays 7 years of synthetic daily weather data (temperature high/low
 * and precipitation) for 8 iconic world cities using the ChartLayout.
 */
public class WeatherApp extends Application {
    ...
    private static final Preferences PREFS = Preferences.userNodeForPackage(WeatherApp.class);

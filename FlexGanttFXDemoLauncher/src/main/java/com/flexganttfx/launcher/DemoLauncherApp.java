...
/**
 * Entry point for the FlexGanttFX Demo Launcher.
 */
public class DemoLauncherApp extends Application {
    ...
    public void start(Stage stage) {
        ...
        view.getStylesheets().add(
                DemoLauncherApp.class.getResource("launcher.css").toExternalForm());

        Scene scene = new Scene(view);
        stage.setTitle("FlexGanttFX – Demo Launcher");

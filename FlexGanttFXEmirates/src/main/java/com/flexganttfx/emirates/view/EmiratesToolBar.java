 ...
 * @since 1.0
 */
public class EmiratesToolBar<R extends Row<?, ?, ?>> extends ToolBar {
	 ...
	 * @since 1.0
	 */
	public EmiratesToolBar(GanttChartBase<R> ganttChart) {
		this();
	...
	private void buildToolBar() {
		...
		if (ganttChart != null) {
			...
			headers.selectedProperty().bindBidirectional(graphics.showRowHeadersProperty());

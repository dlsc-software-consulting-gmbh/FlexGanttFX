...
FlexGanttFX publishing to Maven Central is being set up. These are the coordinates for the upcoming `11.13.19` release.
...
```groovy
implementation "com.flexganttfx:view:11.13.19"
implementation "com.flexganttfx:extras:11.13.19" // optional
```

...
/**
 * Showcase wrapper for the standalone MSProject reader demo.
 */
public class MSProjectDemo extends DemoBase {
    ...
    public String getDescription() {
        return "Reads Microsoft Project (.mpp / .xml) files and displays the task hierarchy " +
               ...
               "Choose from several built-in demo projects or open your own file.";
    }

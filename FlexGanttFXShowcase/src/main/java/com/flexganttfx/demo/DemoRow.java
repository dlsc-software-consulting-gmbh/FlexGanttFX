...
public class DemoRow extends Row<DemoRow, DemoRow, DemoActivity> {
	public static final Layer layer = new Layer("Demo Layer");
	
	public DemoRow(String name, int activityCount) {
		super(name);

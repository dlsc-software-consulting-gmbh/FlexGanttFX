...
public class RowHeaderColumnDemo extends GanttChartDemoBase {
    ...
    private void updateRowHeaderStylesheet(Scene scene, GanttChartBase gantt) {
        ...
        String plain = Objects.requireNonNull(RowHeaderColumnDemo.class.getResource("row-header.css")).toExternalForm();
        String atlantafx = Objects.requireNonNull(RowHeaderColumnDemo.class.getResource("row-header-atlantafx.css")).toExternalForm();

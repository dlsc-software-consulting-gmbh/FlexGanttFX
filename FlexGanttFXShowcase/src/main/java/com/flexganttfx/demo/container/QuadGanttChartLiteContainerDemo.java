...
public class QuadGanttChartLiteContainerDemo extends DemoBase {
    ...
    public Node getPanel(Stage panel) {
        GanttChartLite<DemoRow> chart1 = new GanttChartLite<>();
        GanttChartLite<DemoRow> chart2 = new GanttChartLite<>();
        GanttChartLite<DemoRow> chart3 = new GanttChartLite<>();
        GanttChartLite<DemoRow> chart4 = new GanttChartLite<>();
        ...
        chart1.getRows().add(new DemoRow("Row"));
        chart2.getRows().add(new DemoRow("Row"));
        chart3.getRows().add(new DemoRow("Row"));
        chart4.getRows().add(new DemoRow("Row"));

...
/**
 * A base class for demos that show a single Gantt chart. Subclasses only have to implement
 * {@link #createGanttChart()}. The chart gets wrapped into a pane that also features a
 * toolbar and a status bar.
 */
public abstract class GanttChartDemoBase extends DemoBase {

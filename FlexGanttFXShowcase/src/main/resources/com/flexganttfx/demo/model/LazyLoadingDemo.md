This demo focuses on lazy loading of hierarchical data. It demonstrates how row children can be created on demand instead of upfront, which is an important pattern for large trees and remote or expensive data sources.
...
public class LazyLoadingDemo extends GanttChartDemoBase {
    ...
    private void removeRows() {
        ObservableList<TreeItem<LazyRow>> selectedItems = gantt.getTreeTable().getSelectionModel().getSelectedItems();

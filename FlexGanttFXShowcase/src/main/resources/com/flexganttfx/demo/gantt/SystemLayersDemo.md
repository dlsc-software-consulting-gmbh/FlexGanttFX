This demo focuses on custom system layers. It shows how additional drawing logic can be placed on top of the normal activity rendering pipeline, here by drawing custom connecting lines between activities.

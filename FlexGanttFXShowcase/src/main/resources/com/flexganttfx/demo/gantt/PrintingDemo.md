This demo focuses on printing a Gantt chart. It shows a simple workflow where the chart is rendered to an image snapshot, scaled to the printable area, and then sent to the JavaFX printing API.

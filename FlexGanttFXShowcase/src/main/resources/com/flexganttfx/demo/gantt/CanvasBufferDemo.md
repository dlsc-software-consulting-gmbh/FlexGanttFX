This demo focuses on the canvas and dateline buffering strategy used by **FlexGanttFX**. It shows how scrolling can stay efficient because larger rendered areas are translated and reused instead of being rebuilt on every movement.

This demo focuses on the lite quad-chart container. It shows how four `GanttChartLite` instances can be arranged into a synchronized grid when an application needs several coordinated chart views at once.

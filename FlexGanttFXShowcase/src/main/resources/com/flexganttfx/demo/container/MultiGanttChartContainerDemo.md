This demo focuses on a container with several synchronized Gantt charts. It shows how multiple related views can be shown or hidden while still behaving like one coordinated scheduling surface.

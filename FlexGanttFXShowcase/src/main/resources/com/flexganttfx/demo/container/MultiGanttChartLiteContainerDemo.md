This demo focuses on the lite version of the multi-chart container. It demonstrates how several `GanttChartLite` views can be composed into a synchronized layout for lightweight multi-view scenarios.

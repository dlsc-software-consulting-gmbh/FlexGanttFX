This demo focuses on the `AgendaLayout`, where activities are presented more like agenda entries than traditional bars. It highlights how start time, end time, layout strategy, and cursor-line behavior influence this more calendar-like rendering style.
